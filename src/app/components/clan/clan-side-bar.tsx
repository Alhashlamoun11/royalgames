...
const ClanSideBar = ({topClans,serachFunction,filterByWiningFunction}:any) => {
  ...
  return (
    ...
    <div className="shop__widget">
        <h4 className="shop__widget-title">افضل فرق</h4>
        <div className="shop__widget-inner">
            ...
            <div key={item._id} className="related__products-item">
                <div className="related__products-thumb">
                    <Link href={`/clan/${item._id}`}>
                        <img src={item.image} alt="img" width={78} height={60} />
                    </Link>
                </div>
