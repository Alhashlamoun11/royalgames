    ...
    return match!=null?(
        <Wrapper>
            ...
            <main className="main--area">
                ...
                <BreadcrumbArea title={match&& match.matche.name} prevSuptitle="الاسم: " subtitle={match&& match.matche.name} bg={brd_bg} brd_img={brd_img} />
                {/* breadcrumb area end */}
                                ...
                                <div className="product__desc-wrap">
                                    ...
                                    <div className="tab-content" id="descriptionTabContent">
                                        ...
                                        <div className="tab-pane animation-none fade show active about__content-list" id="info" role="tabpanel" aria-labelledby="info-tab">
                                            <center><h2><TextAnimation title="قائمة المتصدرين" /></h2></center>
                                            ...
                                            <table style={{
                                                ...
                                                <thead>
                                                    <tr className="clan_item_tournmentt">
                                                        <td style={{border:'none'}}>الفرق</td>
                                                        <td style={{border:'none'}}>المستوى</td>
                                                        <td style={{border:'none'}}>النقاط</td>
                                                        <td style={{border:'none'}}>الانتصارات المتتالية</td>
                                                    </tr>
                                                </thead>
                                                <tbody>
                                                    {match && match.clans.map((item:any, index:any) => (
                                                        ...
                                                        style={{
                                                            ...
                                                            boxShadow: "rgb(235 134 15) 0px 2px 5px 0px",
                                                            padding: "7px 13px",
                                                            borderRadius: "7px",
                                                            margin: "0 0 11px",
                                                            fontSize: "16px",
                                ...
                                <div className="product__desc-wrap">
                                    ...
                                    <div className="tab-content" id="descriptionTabContent">
                                        ...
                                        <div className="tab-pane animation-none fade show active" id="challenges" role="tabpanel" aria-labelledby="challenges-tab">
                                            {match && match.challenges.length > 0 ? (<UpcomingMatches challenges={match.challenges} />) : (<center><h5>لا يوجد تحديات بعد</h5></center>)}
...
<Header />
            ...
            <main className="main--area">
                {/* breadcrumb area start */}
                <BreadcrumbAreaTwo title={"...تحميل"}  subtitle={""} />
                {/* breadcrumb area end */}
</main>
<Footer/>
</Wrapper>
